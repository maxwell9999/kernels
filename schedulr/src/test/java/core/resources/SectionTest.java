...
public class SectionTest extends TestCase {
	...
	public void testDatabaseObject() {
		...
		assertEquals("department, course_number, building, room_number, instructor, start_hour, duration, days_of_week, schedule_id", section.getKeys());
...
//		Section labSection = createLabSection(section);
...
//		labSection = createLabSection(section);
//		System.out.println("LAB START TIME: " + labSection.getStartTime());
